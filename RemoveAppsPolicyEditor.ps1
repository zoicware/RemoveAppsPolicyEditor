...
if ($os.BuildNumber -lt 26200) {
    ...
    #you should be able to add any package to the list to remove but it doesnt seem to remove any that arent in the default list

    #get installed pacakges
    #$defaultPackageOptions = (Get-AppxPackage -AllUsers | Where-Object { $_.NonRemovable -eq $false }).packageFamilyName
    #remove dups
    #$defaultPackageOptions = $defaultPackageOptions | Sort-Object -Unique 
    ...
    $window.Title = 'Select Packages'
    $window.Width = 400
    $window.Height = 400
    $window.ResizeMode = 'CanResizeWithGrip'
    $window.Background = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::Black)

    $mainStack = New-Object System.Windows.Controls.StackPanel
    $mainStack.Margin = New-Object System.Windows.Thickness(10)

    $listBox = New-Object System.Windows.Controls.ListBox
    $listBox.Height = 300
    $listBox.SelectionMode = 'Single'  
    $listBox.Background = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::DimGray)
    $listBox.Foreground = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::White)

    foreach ($package in $defaultPackageOptions) {
    ...
    $applyButton.Background = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::DimGray)
    $applyButton.Foreground = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::White)
    $applyButton.Add_Click({
            $window.Close()

            # Collect selected packages
            $selectedPackages = $listBox.Items | Where-Object { $_.IsChecked } | ForEach-Object { $_.Content }
    
            foreach ($packageFamilyName in $selectedPackages) {
                #add app for removal
    ...
    $cancelButton.Background = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::DimGray)
    $cancelButton.Foreground = New-Object System.Windows.Media.SolidColorBrush([System.Windows.Media.Colors]::White)
    ...
    $mainStack.Children.Add($buttonPanel) | Out-Null
